...
customElements.define('tracking-number-card-editor', _index_editor__WEBPACK_IMPORTED_MODULE_4__["default"]);
...
class TrackingNumberCard extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
  static get properties() {
    return {
      hass: Object,
      config: Object,
  ...
  setConfig(config) {
    ...
    this.config = { ..._defaults__WEBPACK_IMPORTED_MODULE_3__["default"], ...config };
  }
   ...
   */
  createHeader() {
    if (this.config.showHeader === false) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
