...
`;function gt(t){const e=new Date(t),i=new Date,s=i.getTime()-e.getTime(),r=Math.floor(s/1e3),o=Math.floor(r/60),n=Math.floor(o/60),a=Math.floor(n/24);return r<60?"just now":o<60?`${o} minute${1!==o?"s":""} ago`:n<24?`${n} hour${1!==n?"s":""} ago`:a<7?`${a} day${1!==a?"s":""} ago`:e.toLocaleDateString(void 0,{month:"short",day:"numeric",year:e.getFullYear()!==i.getFullYear()?"numeric":void 0})}function mt(t){const e=t.toLowerCase(),i={ups:"mdi:package-variant",usps:"mdi:email",fedex:"mdi:truck-fast",dhl:"mdi:airplane",amazon:"mdi:amazon","ui.com":"mdi:package-variant-closed"};for(const[t,s]of Object.entries(i))if(e.includes(t))return s;return"mdi:package"}let vt=class extends nt{setConfig(t){const e={...t},i=e.sort_by;i&&"last_updated"!==i||(e.sort_by="first_seen"),this.config=e}render(){if(!this.hass||!this.config)return I``;const t=this._getTrackingNumberEntities();return I`
    ...
    `}_getTrackingNumberEntities(){return this.hass?Object.keys(this.hass.states).filter(t=>t.startsWith("sensor.")&&t.endsWith("_tracking_numbers")).map(t=>({entity_id:t,friendly_name:this.hass.states[t].attributes.friendly_name||t})).sort((t,e)=>t.friendly_name.localeCompare(e.friendly_name)):[]}_comboBoxValueChanged(t,e){if(!this.config||!this.hass)return;if(this.config[e]===t)return;const i={...this.config,[e]:t};this.config=i;const s=new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0});this.dispatchEvent(s)}_selectChanged(t,e){if(!this.config||!this.hass)return;const i=t.target,s=t.detail?.value;let r=s??i?.value;if("last_updated"===r&&(r="first_seen"),void 0===r)return;if(this.config[e]===r)return;const o={...this.config,[e]:r};this.config=o;const n=new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0});this.dispatchEvent(n)}_valueChanged(t,e){if(!this.config||!this.hass)return;const i=t.target;let s;if(s=""===i.value||void 0===i.value?void 0:"max_items"===e?i.value?parseInt(i.value,10):void 0:i.value,this.config[e]===s)return;const r={...this.config};void 0===s||""===s?delete r[e]:r[e]=s,this.config=r;const o=new CustomEvent("config-changed",{detail:{config:r},bubbles:!0,composed:!0});this.dispatchEvent(o)}_switchChanged(t,e){if(!this.config||!this.hass)return;const i=t.target.checked;if(this.config[e]===i)return;const s={...this.config,[e]:i};this.config=s;const r=new CustomEvent("config-changed",{detail:{config:s},bubbles:!0,composed:!0});this.dispatchEvent(r)}};vt.styles=n`
    .card-config {
      display: flex;
      flex-direction: column;
      gap: 16px;
  ...
  `,t([ht({attribute:!1})],vt.prototype,"hass",void 0),t([ht({attribute:!1})],vt.prototype,"config",void 0),vt=t([ct("tracking-number-card-editor")],vt);console.info("%c TRACKING-NUMBER-CARD %c v4.1.0 ","color: white; background: #039be5; font-weight: bold; padding: 2px 4px; border-radius: 3px 0 0 3px;","color: #039be5; background: white; font-weight: bold; padding: 2px 4px; border-radius: 0 3px 3px 0;");let ft=class extends nt{constructor(){super(...arguments),this.showAddDialog=!1,this.isSubmitting=!1,this.addForm={tracking_number:"",link:"",carrier:"",origin:"",status:""},this.removingTracking={}}setConfig(t){if(!t.entity)throw new Error("You need to define an entity");const e={...t},i=e.sort_by;i&&"last_updated"!==i||(e.sort_by="first_seen"),this.config={show_summary:!0,show_carrier:!0,show_origin:!0,sort_by:"first_seen",sort_direction:"desc",...e}}getCardSize(){return 3}static getConfigElement(){return document.createElement("tracking-number-card-editor")}static getStubConfig(){return{type:"custom:tracking-number-card",entity:"",show_summary:!0,show_carrier:!0,show_origin:!0,sort_by:"first_seen",sort_direction:"desc"}}render(){if(!this.config||!this.hass)return I``;const t=this.hass.states[this.config.entity];if(!t)return this._renderError("Entity not found");const e=t.attributes,i=e.packages||[],s=this.config.sort_by,r=function(t,e="first_seen",i="desc"){const s=(...t)=>{for(const e of t){if(!e)continue;const t=new Date(e).getTime();if(Number.isFinite(t))return t}return 0},r=t=>(t??"").toLowerCase(),o=[...t].sort((t,o)=>{let n,a;switch(e){case"first_seen":default:n=s(t.first_seen,t.last_updated),a=s(o.first_seen,o.last_updated);break;case"last_updated":n=s(t.last_updated,t.first_seen),a=s(o.last_updated,o.first_seen);break;case"carrier":n=r(t.carrier),a=r(o.carrier);break;case"tracking_number":n=r(t.tracking_number),a=r(o.tracking_number)}return n<a?"asc"===i?-1:1:n>a?"asc"===i?1:-1:0});return o}(i,"last_updated"===s?"first_seen":s??"first_seen",this.config.sort_direction??"desc"),o=this.config.max_items?r.slice(0,this.config.max_items):r;return I`
    ...
    `}_renderPackageDetails(t){const e=[];if(this.config?.show_carrier&&e.push(I`
      ...
      `),t.status){const{className:i,icon:s}=function(t){switch((t??"").toLowerCase()){case"delivered":return{className:"status-delivered",icon:"mdi:check-circle"};case"transit":case"pickup":return{className:"status-transit",icon:"mdi:truck-fast"};case"pending":case"inforeceived":return{className:"status-pending",icon:"mdi:clock-outline"};case"exception":case"undelivered":return{className:"status-exception",icon:"mdi:alert-circle"};case"notfound":case"expired":return{className:"status-unknown",icon:"mdi:help-circle"};default:return{className:"status-default",icon:"mdi:information-outline"}}}(t.delivery_status);e.push(I`
        <div class="package-detail">
